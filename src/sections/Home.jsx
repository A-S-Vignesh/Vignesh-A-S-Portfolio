...
import { mainimage, cloud } from "../components/Images";
import SpinningCube from "../components/SpinningCube";
import LaptopFloat from "../three/LaptopFloat";

function Home() {
  return (
    <div className="bg-gradient-bluetowhite dark:bg-gray-800 relative pb-8 dark:bg-gradient-bluetogrey">
      {/* <Spider /> */}
      {/* <SpinningCube /> */}
      ...
      <div className="relative">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-around min-h-screen">
          <div className="text-center lg:text-left md:text-left" data-aos="fade-up">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-4xl p-4 font-bold">A Web Developer</h1>
          </div>
          <div className="">
